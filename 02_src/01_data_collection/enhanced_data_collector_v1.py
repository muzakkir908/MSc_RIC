...
class EnhancedGameDataCollector:
    def __init__(self):
        ...
        self.ping_test_interval = 2  # Test ping every 2 seconds (was 30)
    ...
    def start(self):
        ...
        print("=" * 70)
        print("🎮 ENHANCED GAME DATA COLLECTOR - FIXED VERSION")
        print("=" * 70)
        ...
        # print("\n✨ IMPROVEMENTS:")
        # print("- Better ping measurement to game servers")
        # print("- Improved GPU monitoring")
        # print("- No time constraints")
        # print("- More frequent network testing")
        # print("=" * 70)
